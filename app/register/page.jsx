...
import {
  ...
  Gift, CheckCircle, AlertCircle, Sprout,
} from "lucide-react";
                    ...
                    <Field label="First name" index={0}>
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={inputCls("pl-9 pr-3", form.first_name ? "success" : "default")}
                          required
                        />
                      </div>
                    </Field>
                    <Field label="Last name" index={1}>
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={inputCls("pl-9 pr-3", form.last_name ? "success" : "default")}
                          required
                        />
                      </div>
                    </Field>
                  ...
                  <Field label="Email address" index={2}>
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={inputCls("pl-11 pr-4", form.email ? "success" : "default")}
                        required
                      />
                    </div>
                  </Field>
                    ...
                    {!showReferral ? (
                      ...
                      >
                        ...
                        <p className="text-[11px] mt-1.5"
                          ...
                          {referralLocked
                            ? "You were referred — you'll both earn a reward!"
                            : "Get 10% off your first investment"}
                        </p>
                      </motion.div>
                    )}
                  </Field>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={inputCls("pl-11 pr-12",
                          passedChecks === PASSWORD_CHECKS.length ? "success"
                          : passedChecks > 0 ? "default" : "default"
                        )}
                        required
                      />
                      <button
