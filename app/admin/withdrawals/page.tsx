  ...
  return (
    <div className="fixed inset-0 z-40 flex justify-end">
      ...
      <div className="relative w-full max-w-sm h-full overflow-y-auto border-l border-white/10 flex flex-col"
        ...
        {/* Header */}
        <div className="px-6 py-5 border-b border-white/7 flex items-center justify-between sticky top-0 bg-[#0D1F1A] z-10">
          <div>
    ...
    <div className="min-h-screen bg-[#0D1F1A] relative"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
        ...
        {loading ? (
          ...
          <>
            {/* Desktop table */}
            <div className="hidden md:block rounded-2xl border border-white/7 bg-white/2 overflow-hidden mb-5">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <button onClick={() => setPage((p) => Math.max(1, p - 1))}
                    ...
                    className="w-9 h-9 rounded-xl border border-white/10 bg-white/5 flex items-center justify-center text-white/60 hover:text-white hover:bg-white/10 disabled:opacity-30 transition-all">
                    <ChevronLeft size={15} />
                  </button>
